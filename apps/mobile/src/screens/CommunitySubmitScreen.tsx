...
export default function CommunitySubmitScreen({ navigation }: any) {
  ...
  return (
    <SafeAreaView style={s.container} edges={["top"]}>
      {/* behavior="padding" on iOS, "height" on Android — both allow scrolling to lower fields */}
      <KeyboardAvoidingView
...
function makeStyles(C: ReturnType<typeof import("../lib/ThemeContext").useTheme>["C"]) {
  return StyleSheet.create({
    ...
    backBtnTxt: { fontSize: 17, color: C.text2 },
    ...
    successIcon: { fontSize: 48, color: C.accent, marginBottom: 20 },
    successTitle: {
      fontFamily: "InstrumentSerif_400Regular",
      fontSize: 38,
      color: C.text,
    ...
    doneBtnTxt: { fontFamily: "HankenGrotesk_700Bold", fontSize: 16, color: C.onacc },
  });
}
